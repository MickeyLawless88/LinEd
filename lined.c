...
static void banner(const char *fname)
{
    ...
    puts("=================================================================");
    puts("                   L I N E D   Line Editor Utility               ");
    puts("=================================================================");
    puts("   Version 1.0                     (C) 2025-2026 M. Lawless      ");
    puts("-----------------------------------------------------------------");
    puts("   IBM-PC / CP-M / MS-DOS Compatible Line Editor Program         ");
    puts("   Developed for Teletypes and Serial Console Environments        ");
    puts("-----------------------------------------------------------------");
    printf("   Active File  :  %s\n", upper);
    printf("   System Time  :  %s                                          \n", time_str);
    puts("=================================================================");
    puts("   Ready.  Type '?' for Help or see User Documentation.          ");
    puts("=================================================================");
    puts("");
}
